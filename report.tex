...
%
\paragraph{Constraint 8} If a nurse is present at current hour and wasnt at previous hour, then they traveled to hospital at current hour.
...
\paragraph{Constraint 11} If nurse is present at first hour, then they traveled at first hour.
$$ \forall n \in N,\,$$
$$ T_{n, 1} = P_{n, 1} $$
%
